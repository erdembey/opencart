...
<div id="content">
  ...
  <div class="box">
    <div class="box-heading">
      ...
      <div class="buttons">
        <button type="submit" form="form-klarna-invoice" class="btn"><i class="icon-ok"></i> <?php echo $button_save; ?></button>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="tab-<?php echo $country['code']; ?>">
                  <div class="control-group">
                    <label class="control-label" for="input-merchant<?php echo $country['code']; ?>"><?php echo $entry_merchant; ?> <span class="help-block"><?php echo $help_merchant; ?></span></label>
                    <div class="controls">
                      <input type="text" name="klarna_invoice[<?php echo $country['code']; ?>][merchant]" value="<?php echo isset($klarna_invoice[$country['code']]) ? $klarna_invoice[$country['code']]['merchant'] : ''; ?>" placeholder="<?php echo $entry_merchant; ?>" id="input-merchant<?php echo $country['code']; ?>" />
                    </div>
                  </div>
                  <div class="control-group">
                    <label class="control-label" for="input-secret<?php echo $country['code']; ?>"><?php echo $entry_secret; ?> <span class="help-block"><?php echo $help_secret; ?></span></label>
                    <div class="controls">
                      <input type="text" name="klarna_invoice[<?php echo $country['code']; ?>][secret]" value="<?php echo isset($klarna_invoice[$country['code']]) ? $klarna_invoice[$country['code']]['secret'] : ''; ?>" placeholder="<?php echo $entry_secret; ?>" id="input-secret<?php echo $country['code']; ?>" />
                    </div>
                  </div>
                  <div class="control-group">
                    <label class="control-label" for="input-server<?php echo $country['code']; ?>"><?php echo $entry_server; ?></label>
                    <div class="controls">
                      <select name="klarna_invoice[<?php echo $country['code']; ?>][server]" id="input-server<?php echo $country['code']; ?>">
                  ...
                  <div class="control-group">
                    <label class="control-label" for="input-total<?php echo $country['code']; ?>"><?php echo $entry_total; ?> <span class="help-block"><?php echo $help_total; ?></span></label>
                    <div class="controls">
                      <input type="text" name="klarna_invoice[<?php echo $country['code']; ?>][total]" value="<?php echo isset($klarna_invoice[$country['code']]) ? $klarna_invoice[$country['code']]['total'] : ''; ?>" placeholder="<?php echo $entry_total; ?>" id="input-total<?php echo $country['code']; ?>" />
                    </div>
                  </div>
                  <div class="control-group">
                    <label class="control-label" for="input-pending-status<?php echo $country['code']; ?>"><?php echo $entry_pending_status; ?></label>
                    <div class="controls">
                      <select name="klarna_invoice[<?php echo $country['code']; ?>][pending_status_id]" id="input-pending-status<?php echo $country['code']; ?>">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <select name="klarna_invoice[<?php echo $country['code']; ?>][accepted_status_id]" id="input-accepted-status<?php echo $country['code']; ?>">
                        <?php foreach ($order_statuses as $order_status) { ?>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <select name="klarna_invoice[<?php echo $country['code']; ?>][geo_zone_id]" id="input-geo-zone<?php echo $country['code']; ?>">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <select name="klarna_invoice[<?php echo $country['code']; ?>][status]" id="input-status<?php echo $country['code']; ?>">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="klarna_invoice[<?php echo $country['code']; ?>][sort_order]" value="<?php echo isset($klarna_invoice[$country['code']]) ? $klarna_invoice[$country['code']]['sort_order'] : ''; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order<?php echo $country['code']; ?>" class="input-small" />
                    </div>
                  </div>
                </div>
                <?php } ?>
