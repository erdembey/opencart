              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="tab-<?php echo $country['code']; ?>">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="klarna_invoice[<?php echo $country['code']; ?>][sort_order]" value="<?php echo isset($klarna_invoice[$country['code']]) ? $klarna_invoice[$country['code']]['sort_order'] : ''; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order<?php echo $country['code']; ?>" />
                    </div>
                  </div>
                </div>
                <?php } ?>
