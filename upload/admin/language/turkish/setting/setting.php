...
$_['entry_currency_auto']       = 'Para Birimini Otomatik Güncelle:<br /><span class="help">Para birimlerini günlük olarak otomatik güncelle</span>';
...
$_['entry_customer_online']		= 'Çevirimiçi Müşteriler:<br /><span class="help">Müşterileri, çevrimiçi müşteri raporları bölümünde izleyebilirsiniz.</span>';
...
$_['entry_invoice_prefix']      = 'Fatura Ön-eki:<br /><span class="help">Fatura numarasına ön-ek ekler (örn. INV-2011-00). Benzersiz ön-ek için Fatura No 1\'den başlayacaktır.</span>';
$_['entry_order_status']        = 'Sipariş Durumu:<br /><span class="help">Sipariş işlendiğinde varsayılan sipariş durumunu ayarlayınız</span>';
$_['entry_complete_status']     = 'Sipariş Tamamlandı Durumu:<br /><span class="help">İndirilebilir ürün ve hediye çeklerine erişebilmek için müşteri sipariş durumu burada ayarladığınız sipariş durumuna ulaşması gerekmektedir.</span>';
$_['entry_stock_display']       = 'Stok Miktarını Göster:<br /><span class="help">Ürün sayfasında stok miktarını göster.</span>';
...
$_['entry_stock_status']        = 'Stok Dışı Durumu:<br /><span class="help">Ürün düzenleme sayfasında varsayılan olarak gösterilecek stok dışı durumunu seçiniz.</span>';
...
$_['entry_ftp_root']			= 'FTP Ana Dizini:<span class="help">OpenCart dosyalarının bulunduğu dizin, genellikle \'public_html/\' dizinidir.</span>';
$_['entry_ftp_status']			= 'FTP Açık:';
$_['entry_mail_protocol']       = 'E-Posta Protokol:<span class="help">Only choose \'Mail\' unless your host has disabled the php mail function.';
$_['entry_mail_parameter']      = 'Posta Parametreleri:<span class="help">\'Posta\' da kullanılacak, ilave posta parametreleri girebilirsiniz (örn. "-femail@storeaddress.com".';
